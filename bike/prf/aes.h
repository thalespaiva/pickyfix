...
typedef ALIGN(16) struct aes256_key_s { uint8_t raw[AES256_KEY_SIZE]; } aes256_key_t;
...
typedef ALIGN(16) struct aes256_ks_s { __m128i keys[AES256_ROUNDS + 1]; } aes256_ks_t;
