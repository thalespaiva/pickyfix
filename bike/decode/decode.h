...
ret_t
decode(OUT split_e_t *e, IN const syndrome_t *s, IN const ct_t *ct, IN const sk_t *sk);

ret_t
decode_bgf(OUT split_e_t *e, IN const syndrome_t *s, IN const ct_t *ct, IN const sk_t *sk);
